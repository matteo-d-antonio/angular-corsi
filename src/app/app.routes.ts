...
export const routes: Routes = [
    ...
    {path: 'home/modifica', loadComponent: () => import('./features/home/util/modifica').then(m => m.Modifica)},
    ...
    {path: 'docenti/modifica', loadComponent: () => import('./features/docenti/util/modificaDocente').then(m => m.ModificaDocente)},
